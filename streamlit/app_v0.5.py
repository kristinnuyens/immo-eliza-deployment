...
# --- PAGE SETUP ---
st.set_page_config(page_title="Immo Eliza - Property Price Predictor", page_icon="🏠", layout="wide")
...
# --- FEATURES ---
st.markdown("<h3 style='font-size:20px; margin-bottom:1px;'>📐 Features</h3>", unsafe_allow_html=True)
...
if predict_btn:
    ...
    try:
        ...
        price_placeholder.markdown(f"""
            <div style="background-color:#FFFAE6;padding:15px;border-radius:1px">
